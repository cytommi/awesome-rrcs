...
_G.packer_plugins = {
  ...
  ["nightfox.nvim"] = {
    loaded = true,
    path = "/Users/thomas.wang/.local/share/nvim/site/pack/packer/start/nightfox.nvim",
  ...
  ["nvim-cheat.sh"] = {
    loaded = true,
    path = "/Users/thomas.wang/.local/share/nvim/site/pack/packer/start/nvim-cheat.sh",
  ...
  ["nvim-lsp-installer"] = {
    loaded = true,
    path = "/Users/thomas.wang/.local/share/nvim/site/pack/packer/start/nvim-lsp-installer",
  ...
  popfix = {
    loaded = true,
    path = "/Users/thomas.wang/.local/share/nvim/site/pack/packer/start/popfix",
  ...
  ["tmuxline.vim"] = {
    loaded = true,
    path = "/Users/thomas.wang/.local/share/nvim/site/pack/packer/start/tmuxline.vim",
