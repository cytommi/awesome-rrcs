...
keymap("n", "<C-t>0", ":lua require('harpoon.cmd-ui').toggle_quick_menu()<cr>", opts)
keymap("n", "<C-t>a", ":lua require('harpoon.ui').nav_file(1)<cr>", opts)
keymap("n", "<C-t>r", ":lua require('harpoon.ui').nav_file(2)<cr>", opts)
keymap("n", "<C-t>s", ":lua require('harpoon.ui').nav_file(3)<cr>", opts)
keymap("n", "<C-t>t", ":lua require('harpoon.ui').nav_file(4)<cr>", opts)
